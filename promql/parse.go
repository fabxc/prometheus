...
// matrixSelector parses a matrix selector based on a given vector selector.
//
...
//
//		<metric_namer> | <function_call> | <vector_aggregation> | <literal>
//
...
// package but with longer units. Zero durations are an error.
